        ...
        emailInput.style.border = "1px solid #ccc";
          ...
          passwordInput.addEventListener("blur", function() {
              ...
              if (!regex.test(passwordInput.value)) {
                  passwordError.innerHTML = "Password must be 8 characters long with 1 upper case and 1 symbol";
          ...
          signupForm.addEventListener("submit", function(e) {
            e.preventDefault();
            if (!emailInput.value || !dobInput.value || !passwordInput.value || !confirmPasswordInput.value) {
            alert("Please fill in all the fields");
            return;
            }
            if (emailError.innerHTML || dobError.innerHTML || passwordError.innerHTML || confirmPasswordError.innerHTML) {
